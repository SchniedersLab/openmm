 ...
 */
    ...
    public:
        CommonCalcAmoebaTorsionTorsionForceKernel(const std::string &name, const Platform &platform, ComputeContext &cc,
                                                  const System &system);
 ...
 */
    ...
    public:
        CommonCalcAmoebaMultipoleForceKernel(const std::string &name, const Platform &platform, ComputeContext &cc,
                                             const System &system);
    ...
    protected:
        ...
        void computeSystemMultipoleMoments(ContextImpl &context, std::vector<double> &outputMultipoleMoments);
 ...
 */
    ...
    public:
        CommonCalcAmoebaGeneralizedKirkwoodForceKernel(const std::string &name, const Platform &platform,
         ...
         */
        void computeBornRadii(ComputeArray &torque, ComputeArray &labFrameDipoles, ComputeArray &labFrameQuadrupoles,
                              ComputeArray &inducedDipole, ComputeArray &inducedDipolePolar,
                              ComputeArray &dampingAndThole, ComputeArray &covalentFlags,
                              ComputeArray &polarizationGroupFlags);
 ...
 */
    ...
    public:
        CommonCalcAmoebaVdwForceKernel(const std::string &name, const Platform &platform, ComputeContext &cc,
                                       const System &system);
 ...
 */
    ...
    public:
        CommonCalcAmoebaWcaDispersionForceKernel(const std::string &name, const Platform &platform, ComputeContext &cc,
                                                 const System &system);
 ...
 */
    ...
    public:
        CommonCalcHippoNonbondedForceKernel(const std::string &name, const Platform &platform, ComputeContext &cc,
                                            const System &system);
    ...
    protected:
        ...
        void createFieldKernel(const std::string &interactionSrc, std::vector<ComputeArray *> params,
                               ComputeArray &fieldBuffer,
